    ...
    def build(self, input_tensor):
        ...
        if upsample_type == 'duc':
            x = duc(
                    ...
                    output_shape=(input_shape[0], input_shape[1], self.num_classes))
            out = _conv(
            ...
            out = BilinearUpSampling2D(
                    (self.num_classes, input_shape[0], input_shape[1]),
            ...
            raise ValueError("Error: Upsample Type unknown!")

        out = Activation(self.out_f)(out)
        return out
